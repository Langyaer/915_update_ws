...
"""autogenerated by genpy from lslidar_ch_msgs/LslidarChScanUnified.msg. Do not edit."""
import codecs
import sys
...
class LslidarChScanUnified(genpy.Message):
  _md5sum = "ef8aa3eef1ea793580e2ef69ec4ca588"
  _type = "lslidar_ch_msgs/LslidarChScanUnified"
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint64','lslidar_ch_msgs/LslidarChPacket[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = lslidar_ch_msgs.msg.LslidarChPacket()
        _v4 = val1.header
        start = end
        end += 4
